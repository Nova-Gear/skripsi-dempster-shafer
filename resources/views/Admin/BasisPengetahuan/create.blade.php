...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="title">
                    <h4>Create Data Basis Pengetahuan</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="{{ route('basis_pengetahuan.index') }}">Data Basis
                                Pengetahuan</a></li>
    ...
    <div class="pd-20 card-box mb-30">
        ...
        @endif
        <form method="POST" action="{{ route('basis_pengetahuan.store') }}" id="myForm">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="number" name="densitas" id="densitas" aria-describedby="densitas"
                        placeholder="0.5" step="0.1" min="0.1" max="1.0">
                </div>
            </div>
