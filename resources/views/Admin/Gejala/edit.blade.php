...
@section('content')
    ...
    <div class="pd-20 card-box mb-30">
        ...
        @endif
        <form method="POST" action="{{ route('gejala.update', $gejala->id) }}" id="myForm"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" name="kode_gejala" id="kode_gejala"
                        aria-describedby="kode_gejala" placeholder="" value="{{ $gejala->kode_gejala }}" disabled>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" name="gejala" id="gejala" aria-describedby="gejala"
                        placeholder="" value="{{ $gejala->gejala }}">
                </div>
            </div>
            <div class="form-group row">
